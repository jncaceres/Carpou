...
import { tIndex, tNew, tShow, tEdit, tUpdate, tPost, tDelete } from "./trips";
import { prNew, prShow, prCreate } from "./passenger_requests";
import { uRegister, uSession } from "./users";

export const routes = {
  places: { index: pIndex, show: pShow },
  trips: { index: tIndex, show: tShow, new: tNew, edit: tEdit, update:tUpdate, post:tPost, delete: tDelete},
